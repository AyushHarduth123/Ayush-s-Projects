...
{
    public class AzureProductsQueueService : Controller
    {
        private readonly QueueClient _queueClient;

        public AzureProductsQueueService(string connectionString, string secondqueueName)
        {
            _queueClient = new QueueClient(connectionString, secondqueueName);
